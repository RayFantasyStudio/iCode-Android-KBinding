...
open class OnSuccessListener : OnResponseListener() {
...
open class OnSuccessListener1<T> : OnResponseListener() {
    internal var _onSuccess: ((T) -> Unit)? = null

    internal fun onSuccess(data: T) = _onSuccess?.invoke(data)
...
open class OnSuccessAndProgressListener : OnSuccessListener() {
